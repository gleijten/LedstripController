...
I have been searching some time for a ledstrip controller integration in Home Assistant, which was not depending on a external app for registrations.<BR>
