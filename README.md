...
The drawing below shows the control of 1 colour of the LED strip. For the <a href="https://github.com/gleijten/LedstripController/blob/main/extras/Schema_cpl.png" target="_new">complete schematic</a> and my PCB, <a href="https://github.com/gleijten/LedstripController/tree/main/DesignSpark" >click here</a>.<BR>
